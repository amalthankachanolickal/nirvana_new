...
const togglePass = (elem) => {
	let pass = document.getElementById(`psw${elem}`);
	let toggler = document.getElementById(`show-btn${elem}`);
  ...
  <div class="sign-in-page">
    ...
    padding: 9px 15px;color: #ffffff;margin-top: 6px;">Back to Home</a></p>
               ...
               <div class="sign_in_sec" style="display:block;">
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?php echo SITE_URL;?>controller/SocietyAction.php" id="demo-form" >
                        ...
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                           <label>Password <strong style="color:#FF0000;">*</strong></label>
                            <input type="password" id="psw" name="psw" class="password-wrap" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Password" required>
                            <div class="show-btn" id="show-btn" onclick="togglePass('')">Show</div>
                        ...
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                           <label>Confirm Password <strong style="color:#FF0000;">*</strong></label>
                            <input class="password-wrap" type="password" id="psw2" name="psw2" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required  onBlur="confirmPass()"  placeholder="Repeat Password">
                            <div class="show-btn" id="show-btn2" onclick="togglePass('2')">Show</div>
                           <!-- <i class="la la-lock"></i> --></div>
                        </div>
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
...
<option value="<?php echo strip_tags($GetBlockVal['id']); ?>"><?php echo strip_tags($GetBlockVal['block_name']); ?></option>
            <?php } } } ?>
                        ...
                        <div class="col-lg-6 no-pdd pr-4px" style="" id ='onlyaplfortenant6'>
                          <div class="sn-field">
                        ...
                        <div class="col-lg-6 no-pdd" id ='onlyaplfortenant7'>
                          <div class="sn-field">
                       ...
                       <div class="col-lg-12 no-pdd"id="onlyaplfortenant2">
                          <div class="sn-field">
                           <label>Owner Email <strong style="color:#FF0000;">*</strong></label>
                        ...
                        <div class="col-lg-12 no-pdd">
                          <div class="checky-sec st2">
                            <div class="fgt-sec">
                              ...
                              <small style="font-size: 14px;width: 100%;line-height: 20px;font-weight: 500;">Yes, I understand and agree to the Nirvana Country <a  href="<?php echo SITE_URL;?>terms_conditions.php" target="_blank" style="color: blue;">Terms of Use</a>.</small> </div>
                            <!--fgt-sec end-->
                          </div>
                        </div>
                        <div class="col-lg-12 no-pdd" style="text-align:center">
                                 <!--<button class="g-recaptcha" data-sitekey="6LdpqMAUAAAAAEmEf44bEsDHhdgwYaxb51mBA9gG"  data-callback="onSubmit"  data-action="submit" value="submit" id="Register">Register</button>-->
...
$('#demo-form').submit(function(event) {
      ...
      console.log("in submit");
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('6LfCdcQZAAAAAPliDDHLUTP9qyCF7yMAr5Nx0EVR', {action: 'FirstRegistration'}).then(function(token) {
