...
function confirmPass() {
        var pass = document.getElementById("user_name").value
        var confPass = document.getElementById("cuser_name").value
        if(pass != confPass) {
            alert('Wrong confirm User Name !');
			document.getElementById("cuser_name").value="";
        }
    }
</script>
</head>
    ...
    padding: 9px 15px;color: #ffffff;margin-top: 6px;">Back to Home</a></p>
                ...
                <div class="sign_in_sec" style="display:block;">
                  ...
                  <form method="post" enctype="multipart/form-data" action="<?php echo SITE_URL;?>controller/SocietyAction.php" onSubmit="return validateform();">
                    <input type="hidden" name="ActionCall" value="CustomerUserReset">
                     <input type="hidden" name="userid" value="<?php echo $_REQUEST['userid'];?>">
                    <div class="row">
                      <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                           <label>User Name <strong style="color:#FF0000;">*</strong></label>
                            <input type="text" name="user_name" id="user_name"     required placeholder="User Name">
                           <!-- <i class="la la-lock"></i>--> </div>
                        </div>
                        
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                           <label>Confirm User Name <strong style="color:#FF0000;">*</strong></label>
                            <input type="text" name="cuser_name"  id="cuser_name" onBlur="confirmPass()"    required  placeholder="Repeat User Name">
                           <!-- <i class="la la-lock"></i> --></div>
                        </div>
                      ...
                      <div class="col-lg-12 no-pdd">
                        <button type="submit" class="" value="submit">Reset User Name</button>
                      </div>
                    </div>
                  </form>
                  <!--login-resources end-->
