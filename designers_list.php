...
$getDesignersList = $ModelCall->get("buynsell_designers");
$ModelCall->where("status",1);
                            ...
                            <table class="table table-striped table-hover dt-responsive hide-on-small" id="dataTable" style="width: 100%">
                                ...
                                <thead >
                                    <tr >
                                        ...
                                        <th style="background-color:#4267B2;text-align:center;" scope="col">Contact</th>
                                    </tr>
                                </thead>
                                </br>
                                ...
                                <tbody>
                                    <?php
                                    $c=1;
                                    foreach($getDesignersList as $designerslist){ ?>
                                            <tr>
                                               <td><?php echo $designerslist["first_name"]." ".$designerslist["last_name"]?></td>
                                               <td><a href="tel:<?php echo $designerslist["contact_number"]?>"><?php echo $designerslist["contact_number"]?></a></td>
                                            </tr>
                                   <?php
                                    $c++;
                                    }
