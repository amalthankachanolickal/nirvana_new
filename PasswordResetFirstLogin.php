...
<div class="wrapper">
  <div class="sign-in-page">
    ...
    padding: 9px 15px;color: #ffffff;margin-top: 6px;">Back to Home</a></p>
                ...
                <ul class="sign-control">
                  <li><a href="<?php echo SITE_URL;?>account/login/" title="" style="background-color: #37a000;color: #fff;">Sign in</a></li>
                  <li><a href="<?php echo SITE_URL;?>account/create/" title="">Register</a></li>
                </ul>
                <div class="sign_in_sec" style="display:block;">
                  <h3>Reset Your Password</h3>
                  <?php if($_REQUEST['actionResult']=="regerror"){?>
                  <p style="color: #e00909;font-size: 15px;">Sorry ! This Email is already regsitered with us, please provide another email!</p>
                  <?php } ?>
                  ...
                  <p style="color: #37a000;font-size: 15px;">Password has been successfully sent your registered email address</p>
                  <?php } ?>
                  ...
                  <p style="color: #e00909;font-size: 15px;">Invalid Email ID & Password, please provide an correct Email ID & Password</p>
                  <?php } ?>
                  <form method="post" enctype="multipart/form-data" action="<?php echo SITE_URL;?>controller/SocietyAction.php" onSubmit="return validateform();">
                    <input type="hidden" name="ActionCall" value="FirstLoginPasswordReset">
  ...
  <p id="length" class="invalid">Minimum <b>8 characters</b></p>
                        ...
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                           <label>Confirm Password <strong style="color:#FF0000;">*</strong></label>
                            <input type="password" id="psw2" name="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required onblur="confirmPass()" placeholder="Repeat Password">
                      ...
                      <!--    <p id="captcha" style="margin-left:100px;color:red"></p>-->
                      <!--  </div>-->
                      <!--</div>-->
                      
                      <div class="col-lg-12 no-pdd">
                        <button type="submit" class="" value="submit">Reset Password</button>
                      </div>
                    </div>
                  </form>
                  <!--login-resources end-->
