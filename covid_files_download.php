...
$ModelCall->where("document_title",$_REQUEST['meid']);

$ModelCall->orderBy("id","desc");

$getNoticeInfo = $ModelCall->get("tbl_covid_document");
...
$FindYears = trim($getNoticeInfoVal['created_date']);?> 
        ...
        <tr>
          ...
          <td><a href="<?php echo SITE_URL.MAINADMIN;?>documents/covid/<?php echo $getNoticeInfoVal['document_file'];?>" target="_blank"> <span class="fa fa-download" aria-hidden="true">&#160;</span></a></td>

          <td style="width:10%;"><?php echo $getNoticeInfoVal['created_date'];?></td>

           <td><a href="<?php echo SITE_URL.MAINADMIN;?>documents/covid/<?php echo $getNoticeInfoVal['document_file'];?>" target="_blank"><?php echo $getNoticeInfoVal['document_file_name'];?></a> </td>

                 
                  <td>

                  <a href="<?php echo SITE_URL.MAINADMIN;?>documents/covid/<?php echo $getNoticeInfoVal['document_file'];?>" target="_blank"> <?php echo $getNoticeInfoVal['description'];?></a> 
