...
<!--           
        ...
        <div class="sign_in_sec" style="display:block;padding-left:15px;">
                        <img src="https://www.nirvanacountry.co.in/images/proj_img-1262_4.jpg" style="height: 100px; padding-left: 5px;"> 
                    </div>
...
Remarks - Your Business Name <br><br>
                        ...
                        <div class="col-lg-12 no-pdd">
                          ...
                          <div class="sn-field">
                           ...
                           <textarea id="udf2" name="udf2" ><?php echo $posted['udf2']; ?></textarea></div>
