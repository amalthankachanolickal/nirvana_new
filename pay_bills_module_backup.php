                        ...
                        <div class="col-lg-12 no-pdd">
                         ...
                         ?>
                            ...
                            <?php if($charge['mode']=='NB'){?>
                              <option value="NB"  data-charge="<?php echo $charge['our_charge'];?>" data-gst="<?php echo $charge['GST'];?>" data-type="<?php echo $charge['type'];?>">Net Banking( No Extra Charge)</option>
                            <?php }?>
