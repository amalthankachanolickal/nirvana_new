...
margin:20px;!important ">
               ...
               <div class="row">
                      ...
                      <div class="col-lg-4 no-pdd">
                        ...
                        <div class="col-lg-8 no-pdd"> <h3> Membership Payment</h3>  </div>
                    ...
                    <form action="<?php echo $action; ?>" method="post" name="payuForm">
                        ...
                        <input type="hidden"  name="surl" value="<?php echo SITE_URL;?>/response-payu-membershpform.php"/>

                        <input type="hidden"  name="furl" value="<?php echo SITE_URL;?>/response-payu-membershpform.php"/>

                        <input type="hidden"  name="service_provider" value="payu_paisa"/>

                        <input type="hidden"  name="udf1" value="MembershipPayments"/>

                         <input type="hidden"  name="udf2" value="<?= (isset($_GET['udf2'])) ? $_GET['udf2'] : $posted['udf2'] ?>"/>
                        <input type="hidden"  name="udf3" value="<?= (isset($_GET['udf3'])) ? $_GET['udf3'] : $posted['udf3'] ?>"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 no-pdd pr-4px" style="">
                          ...
                          <div class="sn-field">
                           ...
                           <input name="firstname" id="firstname" value="<?= (isset($_GET['firstname'])) ? $_GET['firstname'] : $posted['firstname'] ?>" required  placeholder="First Name"  />
                        ...
                        <div class="col-lg-6 no-pdd">
                          ...
                          <div class="sn-field">
                            ...
                            <input name="lastname" id="lastname" value="<?= (isset($_GET['lastname'])) ? $_GET['lastname'] : $posted['lastname'] ?>" required placeholder="Last Name" />
                        ...
                        <div class="col-lg-6 no-pdd">
                          ...
                          <div class="sn-field">
                           ...
                           <!-- <label>Email Address <strong style="color:#FF0000;">*</strong></label> -->
                            ...
                            <input type="email" name="email" id="email" onBlur="validateEmail(this);" oninvalid="this.setCustomValidity('Please Enter valid email')"  oninput="this.setCustomValidity('')" required placeholder="Email Address" value="<?= (isset($_GET['email'])) ? $_GET['email'] : $posted['email'] ?>" >
                        ...
                        <div class="col-lg-6 no-pdd">
                          ...
                          <div class="sn-field">
                            ...
                            <td> <input type="text" name="phone" id="phone" oninput="this.setCustomValidity('')"  onKeyPress="return isNumberKey(event);" maxlength="10"  placeholder="Mobile Number" value="<?= (isset($_GET['phone'])) ? $_GET['phone'] : $posted['phone'] ?>" onblur="phonenumber(this.value);"  style="padding:0 5px 0 5px;" required></td>
                        ...
                        <div class="col-lg-12 no-pdd">
                          ...
                          <div class="sn-field">
                           ...
                           <label style="font-size: 14px;width: 96%;line-height: 20px;font-weight: 500;"> Amount</label>
                        <?php if($_GET['udf3']<3){?>
                           <input type="text" name="amount" id="amount" value="500"  readonly onKeyPress="return isNumberKey(event);" maxlength="6"  required/>
                        <?php } else {?>
                        <input type="text" name="amount" id="amount" value="1000"  readonly onKeyPress="return isNumberKey(event);" maxlength="6"  required/>
                        <?php }?>
                           <!-- <i class="la la-lock"></i>--> </div>
                        ...
                        <?php if(!$hash) { ?>
                      <a name="paynow" ></a></a><input type="submit" value="Pay Now" class="btn" style="background-color: #37a000;color:white! important; padding:0! important; width:100px" />
