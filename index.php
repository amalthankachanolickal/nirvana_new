...
<meta name="google-site-verification" content="WlSEocLsu9Rf7afS1ZvFCZRTCJa5sKZ3B-YuAj_Y1Bs" />

<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description"    content="Nirvana Country is the prestigious township in Gurgaon. It is a gated community of villas which homes over 1000 families.">
...
<div class="covid-not d-sm-none" id="covid" style="display:none;">
...
<?php 
    include(ROOTACCESS."front_header.php");
    $current_page = "Home";
?>
        ...
        <div class="carousel-caption">
          ...
          <div class="intro-text">
            ...
            <div class="title clearfix">
              ...
              <?php
                if($HomeSliderBannerVal['button_text']){
            ?>
                <a href="<?=$HomeSliderBannerVal['link']?>" class="btn btn-success" target="<?=($HomeSliderBannerVal['window_type'] == 1 )?'_blank':''?>" rel="noopener noreferrer" ><?=$HomeSliderBannerVal['button_text']?></a>
            <?php
                }
            ?>
            </div>
...
<div class="col-md-12">
 ...
 <div class="container">
     ...
     <div class="row">
        ...
        <!-- <div class="col-md-6 text-center adword">-->
        ...
        <?php 
            ...
            $HomeAd1 = $ModelCall->rawQuery(
                            "SELECT * FROM `tbl_adervitiser_module` where status = 1 order by 1 desc"
                        );
            if($HomeAd1[0] > 0 ){
        ?>
            <div class="col-md-6 text-center adword">
                <div id="myCarousel" data-pause="false" class="carousel slide " data-ride="carousel">
                    <!-- Wrapper for slides -->
                    <div class="carousel-inner">
                        <?php
                            foreach ($HomeAd1 as $key=> $HomeAd1Slider) {
                                if (is_array($HomeAd1Slider) && file_exists(MAINADMIN."ads_managements/photos/".$HomeAd1Slider["image"])) { 
                        ?>
                                <div class="item item-cust <?=($key== 0 )?'active':''?>">
                                    <div class="itemsContainer">
                                        <div class="image">
                                            <a href ="<?=$HomeAd1Slider["url"]?>">
                                                <img src="<?php echo SITE_URL.MAINADMIN."ads_managements/photos/".$HomeAd1Slider["image"]; ?>" alt="Los Angeles" class="ad-item" style="border-radius: 15px; object-fit: fill;height:200px;"></div>
                                            </a>
                                    </div>
                                </div>
        ...
        <?php 
            ...
            $HomeAd1 = $ModelCall->rawQuery(
                            "SELECT * FROM `tbl_adervitiser_module` where status = 1 order by 2 desc"
                        );
            if($HomeAd1[0] > 0 ){
        ?>
            <div class="col-md-6 text-center adword">
...
<script>
  const closeCovid = () => {
    ...
    <?php
    $getFormMessage = $_GET["actionResult"];
    if($getFormMessage == 'Success'){ ?>
       <script>
        alert("Thanks for sharing this. Your information has been submitted to the NRWA office.");
        </script> 
    <?php
    }
    ?>
...
<script>
    ...
    jQuery(document.body).scroll(function() {
        ...
        if (scroll >= 300) {
            ...
            $('.navbar-fixed-top').removeClass('nav-active');
        }
    });
