...
<header>
    <nav class="navbar navbar-default navbar-fixed-top" style="padding-bottom: 0 !important; background: transparent;">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="tablet" href="<?php echo SITE_URL; ?>help-folder/Nirwana%20to%20Home%20Screen.mp4" title="Click here to know how to Add to your mobile Home Screen and access at ease." target="_blank" style="padding: 6px; float:right;" class="d-md-none navbar-right">
...
<!--<hr class="menu-hr">-->
                    ...
                    <li class="d-sm-none">
                        <a href="<?=SITE_URL?>event.php">Events</a>
                    </li>
                    
                    <!--<li style="padding: 0;" class="d-sm-none tablet">-->
                    ...
                    <li>
                        <a href="<?php echo SITE_URL;?>logout.php"  onclick="return confirm('Are you sure you want to logout now ?')" class=" sign-in-up-btn" style=""> <!--margin-top: 6px !important; color:white !important;-->
                            Logout
                        </a>
                    </li>
                    <?php } else {?>
                    ...
                    <li>
                       <a  href="<?php echo SITE_URL;?>login_signup.php" class=" sign-in-up-btn" style="">  <!--margin-top: 6px !important; color:white !important;-->
                            Login
                        </a>
                    </li>
                    <?php }?>
