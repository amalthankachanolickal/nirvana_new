...
<div class="container">
    ...
    <div class="pull-right">
        <a href="buynsell.php"><button class="btn custom_btn" style="background: #37a000;" ><i class="fa fa-plus"></i></button></a>
    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <h2>NIRWANA HOMES </h2>
                                                    <p><a href="sampleForm.php" style="position:absolute;right:10px;top:10px;"  class="pull-right">Add Property</a></p>
                                                 </div>
                                                </div>
