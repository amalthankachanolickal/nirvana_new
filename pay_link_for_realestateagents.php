...
margin:20px;!important ">
               <div class="row">
                      <div class="col-lg-4 no-pdd">
                        ...
                        <div class="col-lg-8 no-pdd"> <h3>Real Estate Agents Registration</h3>  </div>
                  </div>
                    <?php if($formError) { ?>
                    ...
                    <form action="<?php echo $action; ?>" method="post" name="payuForm">
                        ...
                        <input type="hidden"  name="udf1" value="BrokersRegistration"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                           <label> Amount</label>
                           <input type="text" name="amount" value="3000"  onKeyPress="return isNumberKey(event);" maxlength="6" required/>
                           <!-- <i class="la la-lock"></i>--> </div>
                        </div>
                        <div class="col-lg-12 no-pdd" style="text-align:justify;font-size:12px;">
                        Please fill your details as above for listing on the Nirvana Homes  - Real Estate Agents section. 
<br><br>
Benefits for you :<br>
<li>Whenever a resident has some property to buy/rent/sell you get a direct intimation.</li>
<li>Direct leads generated, customer coming to you plus you may get leads for residents other properties as well.</li>
<li>Post your Nirvana listing for free. Residents interested, can directly contact you with one click.</li>
<li>Better visibility for your listings in your area of work</li>
<li>Grab all this at a 50% launch discount for an year @ Rs. 500/-  Rs. 250/- per month only, Rs. 3,000 for one year.  </li>

<a  target="_blank" href='http://nirvana.allrwas.com' style="color:blue;">Click here to see the demo page. </a>

Click here to pay online.<br><br>
...
Remarks - Your Business Name <br>
                        ...
                        <?php if(!$hash) { ?>
                          <input type="submit" value="Submit" class="btn" style="background-color: #37a000;color:white! important; padding:0! important; width:80px" />
