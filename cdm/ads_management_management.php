...
$getads_managementInfo = $ModelCall->get("tbl_ads_management_directory");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        <div class="col-xs-4">
          <h4 class="page-title">Advertise Banner Management</h4>
        </div>
...
if(count($getads_managementInfo)>0){ foreach($getads_managementInfo as $getads_managementVal){ ?>             
                <tr>
                <td><?php echo ucwords($getads_managementVal['ads_management_tilte']);?></td>
                 <td><?php echo ucwords($getads_managementVal['ads_banner_position']);?></td>
                 <td>
                 <?php if($getads_managementVal['ads_banner_type']=="Image"){?>
                 <img src="<?php echo DOMAIN.AdminDirectory;?>ads_managements/<?php echo $getads_managementVal['ads_management_file'];?>" <?php if($getads_managementVal['ads_banner_size']=="300X300"){?>style="width:300px; height:300px;" <?php } ?> <?php if($getads_managementVal['ads_banner_size']=="728X90"){?> style="width:728px; height:90px;" <?php } ?>>
                 <?php } ?>
                  <?php if($getads_managementVal['ads_banner_type']=="GoogleAd"){?>
                 <?php echo $getads_managementVal['google_ads'];?>
                 <?php } ?>
                 </td>
