...
if($posted['month_name']==''){
  $posted['month_name']= date('MY');
}
...
margin:20px;!important ">
               <div class="row">
                    ...
                    <form action="<?php echo $action; ?>" method="post" name="payuForm">
                        ...
                        <input type="hidden"  name="surl" value="<?php echo SITE_URL;?>/response-payu-newsbills.php"/>
                        <input type="hidden"  name="furl" value="<?php echo SITE_URL;?>/response-payu-newsbills.php"/>
                       ...
                       <div class="col-lg-6 no-pdd pr-4px" style="">
                        ...
                        <div class="col-lg-6 no-pdd">
                          <div class="sn-field">
                            ...
                            <input name="month_name" id="month_name" value="<?php echo strtoupper($posted['month_name']); ?>" readonly disabled/>
                            <!--<i class="la la-user"></i>--> </div>
                        </div>
                      ...
                      <!-- <div class="col-lg-4 no-pdd">
                        ...
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                           ...
                           <input type="text" name="amount" value="<?php echo (empty($posted['amount'])) ? $amount : $posted['amount'] ?>"  onKeyPress="return isNumberKey(event);" maxlength="6"/>
                           <!-- <i class="la la-lock"></i>--> </div>
                        </div>
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                        ...
                        <div class="col-lg-6 no-pdd">
                          <div class="sn-field">
                           <label> Zipcode : </label>
                           <input  type="text"  name="zipcode" value="<?php echo (empty($posted['zipcode'])) ? '' : $posted['zipcode']; ?>"  onKeyPress="return isNumberKey(event);" maxlength="7" />
                           <!-- <i class="la la-building-o"></i> --></div>
                        </div>
                        ...
                        <div class="col-lg-12 no-pdd">
                           <div class="checky-sec st2">
                            <div class="fgt-sec">
                              ...
                              <small style="font-size: 14px;width: 96%;line-height: 25px;font-weight: 500;">Yes, I understand and agree to the <a  target="_blank" href='<?php echo SITE_URL;?>/TNC_newspaper.php'> <strong style="color:#008000;">Newspapers Terms and Conditions</a>.</small> </div>
                            <!--fgt-sec end-->
                          </div>
                        </div>
                        </div>
