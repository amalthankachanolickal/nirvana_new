    ...
    padding: 9px 15px;color: #ffffff;margin-top: 6px;">Back to Home</a></p>
                ...
                <div class="sign_in_sec" style="display:block;">
                  ...
                  <form method="post" enctype="multipart/form-data" action="<?php echo SITE_URL;?>controller/SocietyAction.php" onSubmit="return validateform();">
                    <input type="hidden" name="ActionCall" value="CustomerPasswordReset">
                        ...
                        <div class="col-lg-12 no-pdd">
                          <div class="sn-field">
                           <label>Confirm Password <strong style="color:#FF0000;">*</strong></label>
                            <input type="password" id="psw2" name="psw2" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" onBlur="confirmPass()"  required>
                           <!-- <i class="la la-lock"></i> --></div>
                        </div>
                                     <div id="message">
