...
<!--<script src="https://www.google.com/recaptcha/api.js?render=6LfCdcQZAAAAAPliDDHLUTP9qyCF7yMAr5Nx0EVR"></script>-->
  ...
  <div class="sign-in-page">
          ...
          <div class="row" style="margin: 0;">
            <div class="col-lg-6">
              <div class="cmp-info text-center">
                <div class="cm-logo col-lg-12"> <a  href="<?php echo SITE_URL;?>"><img src="<?php echo SITE_URL.MAINADMIN.SITELOGO;?>" alt=""> </a></div>
                <!--cm-logo end-->
    ...
    padding: 9px 15px;color: #ffffff;margin-top: 6px;">Back to Home</a></p>
                ...
                <ul class="sign-control">
                  <li><a href="<?php echo SITE_URL;?>login_signup.php" title="" style="background-color: #37a000;color: #fff;">Login</a></li>
                ...
                <div class="sign_in_sec" style="display:block;">
                  ...
                  <?php } ?>
                   <?php if($_REQUEST['actionResult']=="Pleaselogin"){?>
                  <p style="color: #e00909;font-size: 15px;">Please Login before listing your property</p>
                  <?php } ?>
                   <?php if($_REQUEST['actionResult']=="pleaseloginbeforesubmitting"){?>
                  <p style="color: #e00909;font-size: 15px;">Please Login before nominating.</p>
                  <?php } ?>
                  ...
                  <!--  <?php if($_REQUEST['actionResult']=="novalidCaptcha"){?>
                  <p style="color: #e00909;font-size: 15px;">Not Valid Login, Looks like some Spam. </p>
                  <?php } ?>-->
                  
                  <?php if($_REQUEST['actionResult']=="loginerror"){?>
                  <p style="color: #e00909;font-size: 15px;"> Your account is pending approval from the Admin. Due to the initial set up, the process may take us a few days.</p>
...
or click here to <a href="<?php echo SITE_URL;?>account/create/" title=" style="text-decoration: underline;">register your account</a>.</p>
                  ...
                  <form method="post" enctype="multipart/form-data" id="demo-form" action="<?php echo SITE_URL;?>controller/SocietyAction.php">
                    <input type="hidden" name="ActionCall" value="LoginAccessNew">
                    <!--<input type="hidden" name="token" id="token" /> -->
                    <?php if(isset($_REQUEST['back_tracker'])){?>
                    <input type="hidden" name="back_tracker" value="<?php echo $_REQUEST['back_tracker']; ?>">
                    <?php }?>
                      <?php if(isset($_REQUEST['view-mode'])){?>
                    <input type="hidden" name="view_mode" value="<?php echo $_REQUEST['view-mode']; ?>">
                    <?php }?>
                    <div class="row">
                      <div class="col-lg-12 no-pdd">
                        <div class="sn-field">
                          <label>User Name <strong style="color:#FF0000;">*</strong></label>
                          <input type="text" name="user_email" id="user_email" value="<?php  if(isset($_COOKIE["cookie_name"])) {echo $_COOKIE["cookie_name"];} ?>" required  title="Enter Email Address" placeholder="Enter User Name ">
                      ...
                      <div class="col-lg-12 no-pdd">
                        <div class="sn-field">
                          ...
                          <input  type="password" name="user_pass_login" id="user_pass_login" value="<?php if(isset($_COOKIE["cookie_pass"])) {echo $_COOKIE["cookie_pass"];} ?>"  oninvalid="this.setCustomValidity('Enter Password')"  oninput="this.setCustomValidity('')" required title="Enter Password" placeholder="Enter Password">
                      ...
                      <div class="col-lg-12 no-pdd">
                          <div class="checky-sec st2">
                            <div class="fgt-sec">
                              ...
                              <input type="checkbox" id="remember" name="remember"  <?php if(isset($_COOKIE["cookie_name"])) { ?> checked <?php } ?> >
                              <span class="checkmark"></span> </label>
                              <small style="font-size: 14px;width: 100%;line-height: 20px;font-weight: 500;">Remember me</small>
                              </div>
                          </div>
                        </div>
                        <br>
               ...
               <!--<div class="col-lg-12 no-pdd">
                       <div class="sn-field">
                        <div class="g-recaptcha" id="rcaptcha" data-sitekey="6LdIf6YUAAAAAMG4oIQvhv9qEvFxdSAZgacQCQhN" width="80%"></div>
               ...
               <?php // }?>
                      <div class="col-lg-12 no-pdd">
                          <div class="checky-sec st2">
                            <div class="fgt-sec">
                              <label class="check-new-box">
                              <input type="checkbox" id="policy_accept" name="policy_accept" value="1" checked >
                              <span class="checkmark"></span> </label>
                              <small style="font-size: 14px;width:80%;line-height: 20px;font-weight: 500;">Yes, I understand and agree to the Nirvana Country <a  href="<?php echo SITE_URL;?>terms_conditions.php" target="_blank" style="color: blue;">Terms of Use</a>.</small> </div>
                            <!--fgt-sec end-->
                          </div>
                        </div>
                        <div class="col-lg-4 no-pdd">
                      </div>
                      <div class="col-lg-4 no-pdd" id="btn1" style="text-align:center">
                      <!--<button class="g-recaptcha" data-sitekey="6LdpqMAUAAAAAEmEf44bEsDHhdgwYaxb51mBA9gG"  data-callback="onSubmit"  data-action="submit" value="submit" id="signin_click">Sign in</button>-->
                        <button type="submit" class="" value="submit" id="signin_click">Login</button>
                      </div>
                      <div class="col-lg-4 no-pdd">
                      </div>
                      <div class="col-lg-3 no-pdd">
                       ...
                       <div class="col-lg-8 no-pdd"  style="text-align:center">
                       <a href="#" data-toggle="modal" data-target="#forgotusername" title="" style="color:#337ab7;font-size: 12px;";>Forgot UserName?</a> &nbsp;
                          <a href="#" data-toggle="modal" data-target="#forgotPassword" title="" style="color:#337ab7;font-size: 12px;";>Forgot Password?</a> </div>
                      </div>
                      <div class="col-lg-4 no-pdd">
                      </div>
                    </div>
  ...
  console.log("in validateform");
    // needs for recaptacha ready
        grecaptcha.ready(function() {
            // do request for recaptcha token
            // response is promise with passed token
            grecaptcha.execute('6LfCdcQZAAAAAPliDDHLUTP9qyCF7yMAr5Nx0EVR', {action: 'login'}).then(function(token) {
                // add token to form
...
/*$('#demo-form').submit(function(event) {
      ...
      console.log("in submit");
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('6LfCdcQZAAAAAPliDDHLUTP9qyCF7yMAr5Nx0EVR', {action: 'LoginAccessNew'}).then(function(token) {
                 $('#demo-form').prepend('<input type="hidden" name="token" value="' + token + '">');
