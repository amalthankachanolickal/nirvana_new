...
if(count($getads_managementInfo)>0){ foreach($getads_managementInfo as $getads_managementVal){ ?>             
                <tr>
                    <?php if($getads_managementVal['category']!=""){?>
                <td><?php echo ucwords($getads_managementVal['category']);?>/<?php echo ucwords($getads_managementVal['sub_category']);?>/<?php echo ucwords($getads_managementVal['sub_sub_category']);?></td><?php }else{?>
                 ...
                 <td>
                 <?php if($getads_managementVal['image']!=""){?>
                 <img src="<?php echo DOMAIN.AdminDirectory;?>ads_managements/photos/<?php echo $getads_managementVal['image'];?>" style="width:400px; height:200px;">
                 <?php } ?>
                  <?php if($getads_managementVal['text_advertisement']!=""){?>
                 <?php echo $getads_managementVal['text_advertisement'];?>
                 <?php } ?>
                 </td>
