...
if($_REQUEST['bill_date']!='')
{
    ...
    if($first){
        $where= "where";
        $where=$where." date_received = '".$bill_date_s."'";
    }
    else{
        $where=$where." and date_received = '".$bill_date_s."'";
    }
     $first=0;
 }
...
$getDriverInfo = $ModelCall->rawQuery("select * from tbl_billing_new left join tbl_bill_payment_details on tbl_bill_payment_details.bill_num=tbl_billing_new.bill_number ".$where." order by bill_date desc limit 100");
...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        ...
        <div class="col-xs-9 text-right m-b-30"> 
            ...
            <a href="<?php echo DOMAIN.AdminDirectory;?>billing_upload_sample_new.xlsx" class="btn btn-danger rounded" target="_blank" style="margin-right:4px;" ><i class="fa fa-download"></i> Download Format</a>  
            <a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#upload_billing"><i class="fa fa-plus"></i> Upload Billing</a> 
            <a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#new_uploader"><i class="fa fa-plus"></i>New Uploader</a> 
      ...
      <div class="row ">
        <form class="m-b-30" action="<?php echo DOMAIN.AdminDirectory;?>billing_management_report.php" method="post" enctype="multipart/form-data">
    ...
    <option value="DW">DW</option>
     <option value="ES">ES</option>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="house_number" pattern="[0-9]{0-4}" placeholder="Enter your 3 Digit House No" title="Three Digit House No"  value="" type="text" maxlength="3">
                  </div>
   ...
   <option value='1'>Ground Floor</option>
        ...
        <div class="col-md-1"> <label class="control-label"></label><button type="submit"  class="btn btn-success btn-block"> <span class="glyphicon glyphicon-search"></span> </button> </div>
        <div class="col-md-3"> <button type="submit" name='download_csv' value ='1' class="btn btn-success btn-block">  <i class="fa fa-download"></i> Download Result CSV </button> </div>
