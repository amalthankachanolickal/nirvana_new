<div id="add_decline_comment_<?= $getDocumentVal['id'] . '_' . $frm ?>" class="modal custom-modal fade" role="dialog">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                <label class="control-label">Reason for decline <span class="text-danger">*</span></label>
