...
$ModelCall->where("page_name","privacy-policy");
...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        <div class="col-xs-8">
          <h4 class="page-title">CMS Management - Privacy & Policy</h4>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
         <?php if($_REQUEST['actionResult']!='') { include('messageDisplay.php'); }?>
          ...
          <input type="hidden" name="ActionCall" value="AddUpdateCMSManagementPrivacy">
