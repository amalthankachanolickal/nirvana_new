...
?>
<option value="<?php echo strip_tags($GetCityVal['id']); ?>"><?php echo strip_tags($GetCityVal['category_name']); ?></option>
            <?php } } } ?>
          </select>
              </div>
            </div>
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="sub_category_name" id="sub_category_name" required value="" >
              </div>
            </div>
