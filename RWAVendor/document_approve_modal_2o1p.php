<div id="document_approve_modal_2o1p-<?php echo $getDocumentVal['s_no'];?>" class="modal custom-modal fade" role="dialog">
      ...
      <div class="modal-content modal-lg">
        ...
        <div class="modal-body">
          <div class="m-b-30">
            ...
            <input type="hidden" name="doc_type" value="2o1">
              <div class="col-md-12">
                <div class="row">
