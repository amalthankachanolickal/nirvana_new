    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content modal-lg">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="ActionCall" value="UpdateCovidDocument">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="document_name" id="document_name<?php echo $getAdminInfo[0]['id'];?>" required value="<?php echo $getDocumentVal['document_file_name'];?>" >
              ...
              <div class="col-sm-6">
               ...
               <?php if($getDocumentVal['document_file']!=''){?>
                ...
                <div class="form-group">
                  ...
                  <a href="<?php echo DOMAIN.AdminDirectory;?>documents/covid/<?php echo $getDocumentVal['document_file'];?>" target="_blank"><?php echo $getDocumentVal['document_file_name'];?></a>
