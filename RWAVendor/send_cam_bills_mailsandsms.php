  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
     ...
     <form class="m-b-30" name="theForm" action="<?php echo DOMAIN.AdminDirectory;?>controller/bills_upload_Controller.php" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="ActionCall" value="TriggerMailandSMS">
            <input type="hidden" name="start_bill_date" id="start_bill_date" value="">
               <input type="hidden" name="trigger_to" id="trigger_to" value="">
      <div class="row">
        <div class="col-md-12">
                             ...
                             <div class="dropdown"> 
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                    <ul class="dropdown-menu pull-left">
                                        ...
                                        if(count($getNotificationFlag)==0){?>
                                        <li><a href="#"  onclick="SelectedOption('<?php echo $getCustomerInfoVal['latest_bill_date'];?>', 1)" >Send Mail to All</a></li>
                                        <li><a href="#" onclick="SelectedOption('<?php echo $getCustomerInfoVal['latest_bill_date'];?>',0)">Send Mail to only O/S</a></li>
                                        <?php } else{ ?>
                                        <li><a href="#"  onclick="SelectedOption('<?php echo $getCustomerInfoVal['latest_bill_date'];?>', 1)" >Send Mail & SMS to All</a></li>
                                        <li><a href="#" onclick="SelectedOption('<?php echo $getCustomerInfoVal['latest_bill_date'];?>',0)">Send Mail & SMS to only O/S</a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </td>
...
<script>
  ...
  $('#example').dataTable({
   ...
   function SelectedOption(start_bill_date, checkoption){
