...
<title>Survey Result Management - <?php echo SITENAME;?></title>
...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        <div class="col-xs-4">
          <h4 class="page-title">Survey Result Management</h4>
        </div>
...
if(count($getDocumentInfo)>0){ foreach($getDocumentInfo as $getDocumentVal){ ?>             
                <tr>
                <td><?php echo ucwords($getDocumentVal['survey_name']);?></td>
                 <td><a href="<?php echo DOMAIN.AdminDirectory;?>documents/<?php echo $getDocumentVal['document_file'];?>" target="_blank"><?php echo $getDocumentVal['document_file_name'];?></a></td>
                  ...
                  <td class="text-right">
                  <a href="#" data-toggle="modal" data-target="#delete_document<?php echo $getDocumentVal['id'];?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
            ...
            <tr>
              ...
              <td><div class="dropdown"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                ...
                <?php include('delete_survey_document.php'); ?>
  ...
  <?php include('add_survey_result_document.php'); ?>
