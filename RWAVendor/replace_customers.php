<div id="replace_customers" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog">
      <button type="button" class="close" data-dismiss="modal">&times;</button>
      <div class="modal-content modal-lg">
        <div class="modal-header">
          <h4 class="modal-title">Replace Existing Customers</h4>
        </div>
        <div class="modal-body">
          <form class="m-b-30" action="<?php echo DOMAIN.AdminDirectory;?>controller/FunctionCall.php" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="ActionCall" value="ReplaceCustomerExpert">
            <div class="row">
            <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="customer_excel_sheet_upload" id="customer_excel_sheet_upload" required type="file">
                   <br /> <p><strong style="color:#FF0000;"><a href="<?php echo DOMAIN.AdminDirectory;?>nirwana_customer_import_example.xlsx" class="btn btn-danger rounded" target="_blank" style="margin-right:4px;" ><i class="fa fa-download"></i> Download Format</a></strong></p>
                </div>
              </div>
