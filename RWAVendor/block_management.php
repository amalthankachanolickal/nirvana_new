...
<title>Blocks Management - <?php echo SITENAME;?></title>
...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        <div class="col-xs-4">
          <h4 class="page-title">Block Management</h4>
        </div>
...
if(count($getBlocksManagementInfo)>0){ foreach($getBlocksManagementInfo as $getBlocksVal){ ?>             
                <tr>
                <td><?php echo $i;?></td>
                <td><?php echo ucwords($getBlocksVal['block_name']);?> - <?php echo ucwords($getBlocksVal['block_code']);?></td>
                   <td><?php echo ucwords($getBlocksVal['created_date']);?></td>
                   <td><?php echo ucwords($getBlocksVal['created_ip']);?></td>
                  <td class="text-right">
				  
				  <table width="100%">
  <tr>
    <td> <?php if($getBlocksVal['status']==1){?> <a href="#" data-toggle="modal" data-target="#deactivate_Blocks<?php echo $getBlocksVal['id'];?>" class="btn btn-success">Active</a><?php } else { ?> <a href="#" data-toggle="modal" data-target="#activate_Blocks<?php echo $getBlocksVal['id'];?>" class="btn btn-danger">Inactive</a> <?php } ?> </td>
    <td><div class="dropdown"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                      <ul class="dropdown-menu pull-right">
                        <li><a href="#" data-toggle="modal" data-target="#edit_Blocks<?php echo $getBlocksVal['id'];?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
                        <li><a href="#" data-toggle="modal" data-target="#delete_Blocks<?php echo $getBlocksVal['id'];?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a></li>
                      </ul>
                    </div></td>
  </tr>
</table>
                 ...
                 <?php include('edit_Blocks_management.php'); ?>
    <?php include('delete_Blocks_management_confirm.php'); ?>
      <?php include('activate_Blocks_management_confirm.php'); ?>
        <?php include('deactivate_Blocks_management_confirm.php'); ?>
                <?php 
				$i++;
				} } else {?>
  ...
  <?php include('add_Blocks_management.php'); ?>
