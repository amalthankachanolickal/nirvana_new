...
$ModelCall->where("page_name","terms-conditions");
...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        <div class="col-xs-8">
          <h4 class="page-title">CMS Management - Terms & Conditions</h4>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
         <?php if($_REQUEST['actionResult']!='') { include('messageDisplay.php'); }?>
          ...
          <input type="hidden" name="ActionCall" value="AddUpdateCMSManagementTerms">
            ...
            <input type="hidden" name="client_id" value="<?php echo $getAdminInfo[0]['id'];?>" />
             <input type="hidden" name="page_name" value="terms-conditions" />
            <div class="row">
