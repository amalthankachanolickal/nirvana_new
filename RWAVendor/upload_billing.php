    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content modal-lg">
        ...
        <div class="modal-body">
          <form class="m-b-30" action="<?php echo DOMAIN.AdminDirectory;?>controller/bills_upload_Controller.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="client_id" value="<?php echo $getAdminInfo[0]['id'];?>" />
            <input type="hidden" name="ActionCall" value="AddBillingNew">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="customer_excel_sheet_upload" id="customer_excel_sheet_upload" required type="file">
                   <br /> <p><strong style="color:#FF0000;"><a href="<?php echo DOMAIN.AdminDirectory;?>billing_upload_sample_newest.xlsx" class="btn btn-danger rounded" target="_blank" style="margin-right:4px;" ><i class="fa fa-download"></i> Download Format</a></strong></p>
                </div>
              </div>
                   <div class="col-sm-6">
                <div class="form-group">
