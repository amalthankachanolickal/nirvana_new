<div id="document_approve_modal_cd-<?php echo $getDocumentVal['s_no'];?>" class="modal custom-modal fade" role="dialog">
      ...
      <div class="modal-content modal-lg">
        ...
        <div class="modal-body">
          <div class="m-b-30">
            ...
            <input type="hidden" name="doc_type" value="cd">
              <div class="col-md-12">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-9" style="padding: 7.5px 0px;">
                    <a href="<?= SITE_URL ?><?= $getDocumentVal['ConveyanceDeed'] ?>" target="_blank">click here</a>
                  </div>
                </div>                
                <div class="row">
                  <div class="col-md-3" style="padding: 7.5px 0px;"><b>Comment Added by user : </b></div>
                  <div class="col-md-9" style="padding: 7.5px 0px;">
                    <?= $getDocumentVal['ConveyanceDeed_comment'] ?>
                  </div>
                </div>
