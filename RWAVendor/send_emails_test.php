  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
       <?php if($_REQUEST['actionResult']!='') { include('messageDisplay.php'); }?>
        <div class="col-md-8 col-md-offset-2">
          ...
          <input type="hidden" name="ActionCall" value="sending_emails_test">
      ...
      <div class="col-sm-12">
                ...
                <input class="form-control" name="from_id" id="from_id" ></input>
                   <input class="form-control" name="to_id" id="to_id" ></input>
                </div>
              </div>
