<div id="document_approve_modal_1o2p-<?php echo $getDocumentVal['s_no'];?>" class="modal custom-modal fade" role="dialog">
      ...
      <div class="modal-content modal-lg">
        ...
        <div class="modal-body">
          <div class="m-b-30">
            ...
            <input type="hidden" name="doc_type" value="1o2">
              <div class="col-md-12">
                <div class="row">
