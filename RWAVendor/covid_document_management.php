...
$getDocumentInfo = $ModelCall->get("tbl_covid_document");
?>
<!DOCTYPE html>
<html>
<head>
...
<title>Covid Document Management - <?php echo SITENAME;?> admin | Php Expert Technologies Pvt. Ltd.</title>
...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        <div class="col-xs-4">
          <h4 class="page-title">Covid Document Management</h4>
        </div>
        <div class="col-xs-8 text-right m-b-30"> <a href="#" class="btn btn-primary pull-right rounded" data-toggle="modal" data-target="#add_document"><i class="fa fa-plus"></i> Add Document</a> <a href="#" class="btn btn-primary pull-right rounded" data-toggle="modal" data-target="#approve_document"><i class="fa fa-plus"></i> Approve Document</a>
...
if(count($getDocumentInfo)>0){ foreach($getDocumentInfo as $getDocumentVal){ ?>             
                <tr>
                <td><?php echo ucwords($getDocumentVal['document_title']);?></td>
                 <td><a href="<?php echo DOMAIN.AdminDirectory;?>documents/covid/<?php echo $getDocumentVal['document_file'];?>" target="_blank"><?php echo $getDocumentVal['document_file_name'];?></a></td>
  ...
  <tr>
    ...
    <td><div class="dropdown"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                 ...
                 <?php include('edit_covid_document.php'); ?>
    <?php include('delete_covid_document_confirm.php'); ?>
      <?php include('activate_covid_document_confirm.php'); ?>
        <?php include('deactivate_covid_document_confirm.php'); ?>
                <?php } } else {?>
  ...
  <?php include('add_covid_document.php'); ?>
  <?php include('approve_covid_document.php'); ?>
