<div id="view_booking<?php echo $getCustomerInfoVal['id'];?>" class="modal custom-modal fade" role="dialog">
    ...
    <div class="modal-content modal-lg">
      ...
      <div class="modal-body">
          ...
          <!-- <table>
               ...
               <tr>
                   <td>Age</td>
                   <td><?php /*echo  $b["Age"]; */?> - <?php /*echo  $b["DOB"]; */?></td>
               </tr>
               <tr>
                   <td>Email</td>
               ...
               <tr>
                   <td>Vaccine Date& Time</td>
                   <td><?php /*echo  $b["vaccine1_date"]; */?> - <?php /*echo  $b["vaccine1_time"]; */?> </td>
               </tr>
           </table>-->
          <div class="row">
