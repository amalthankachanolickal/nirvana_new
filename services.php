        ...
        <div class="col-md-12" style="align:center;">
         <?php if($_REQUEST['actionResult']!='') { include('messageDisplay.php'); }?>
          <div class="table-responsive">
            ...
            <table class="table table-striped custom-table datatable table-bordered table-dark ">
...
$FindYears = trim($getNoticeInfoVal['created_date']);?>             
                <tr>
                  <td align="center"><p>  <a href="<?php echo SITE_URL.MAINADMIN;?>documents/<?php echo $getNoticeInfoVal['document_file'];?>" target="_blank"> <i class="fa fa-file" aria-hidden="true"></i></a></p> </td>
