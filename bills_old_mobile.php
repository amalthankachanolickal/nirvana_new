      ...
      <tbody>
        ...
        <tr>
         ...
         ?>
          ...
          <td > 
                <a href="<?php echo SITE_URL;?>bills_mobile_by_id.php?bill_number=<?php echo ucwords($value['bill_number']);  ?>" target="_blank" >   <?php echo dateformatchange($value['bill_date']);?> 
                  
              </a> 
              </td>
                 <td> <a href="<?php echo SITE_URL;?>bills_mobile_by_id.php?bill_number=<?php echo ucwords($value['bill_number']);  ?>" target="_blank"> <?php echo ucwords($value['total_outstanding']);  ?></td></a> 
 <td> <a href="<?php echo SITE_URL;?>bills_mobile_by_id.php?bill_number=<?php echo ucwords($value['bill_number']);  ?>" target="_blank"> <?php echo ucwords($value['amt_paid']);  ?></td></a> 
