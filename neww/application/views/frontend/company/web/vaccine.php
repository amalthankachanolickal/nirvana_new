                    ...
                    <div class="col-lg-12">
                        <div class="login-sec">
                            <div class="myimg col-12 col-sm-12 order-md-2 order-sm-1 order-1 text-center text-md-left logo">
                                <a href="https://www.nirvanacountry.co.in/"><img
                                    ...
                                    <li style="color:white;">
                                        <div class="">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 min-des no-pdd">
                                                    <div class="sn-field">
                                                        <input type="text" name="mname" id="mname" value="<?php echo $getUser->middle_name; ?>"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 min-des no-pdd">
                                                    <div class="sn-field">
                                                        <?php if ($getUser->block_id <> NULL || $getUser->block_id <> '') { ?>
                                                        <input type="text" required
                                                               name="block_prime" id="block_prime"
                                                               
                                                               value="<?php if ($getUser->block_id == 1) {
                                                               echo "AG";
                                                               }else if ($getUser->block_id == 2) {
                                                               echo "BC";
                                                               }else if ($getUser->block_id == 3) {
                                                               echo "CC";
                                                               }else if ($getUser->block_id == 4) {
                                                               echo "DW";
                                                               }else if ($getUser->block_id == 5) {
                                                               echo "ES";
                                                               }
                                                               ?>"
                                                               placeholder="Block" readonly>
                                                               <?php } 
                                                         else{ ?>
                                                ...
                                                <div class="col-md-4 min-des no-pdd">
                                                    <div class="sn-field">
                                                        <input type="text" required
                                                               ...
                                                               placeholder="House #" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 min-des no-pdd">
                                                    <div class="sn-field">
                                                    <?php if ($getUser->floor_number <> NULL || $getUser->floor_number <> '') { ?>
                                                        <input type="text" required
                                                               name="floor_prime" id="floor_prime" value="<?php echo $getUser->floor_number
                                                               
                                                               ?>"
                                                               placeholder="Floor" readonly>
                                                               <?php
                                                            } else {
                                                                ?>
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td width="30%"><input type="text" name="isd_1"
                                                                                       ...
                                                                                       required></td>
                                                                <td width="70%"><input type="text" min="10" required value="<?php echo $getUser->phone_number; ?>"
                            ...
                            <div id="firstV_div" class="col-md-8"  style="display: none;"> 
                                <div class="col-sm-5" style="margin: unset;" >
                                    <div class="sn-field">
                                        ...
                                        <input type="text" name="vaccine1_date"
                                               id="vaccine1_date"
                                ...
                                <div id="second_div" style="display: none;">
                                  <div class="col-sm-3">
                                    <div class="sn-field">
                                        ...
                                        <label>Dose1 Vaccine Name</label> 
...
<script>
    $(document).ready(function () {
        $('input[id$=vaccine1_date]').datepicker({
            dateFormat: 'dd/mm/yy',
            minDate:'02/05/2021' ,
            maxDate:'03/05/2021'
        });
