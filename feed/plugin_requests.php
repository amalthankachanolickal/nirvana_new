...
/* plugins ajax */
if(file_exists("assets/plugins/request_admin.php") && ($only == 'admin' || $only == 'all')){ include "assets/plugins/request_admin.php";  }

if(in_array('Ads', $wo['plugin_list']['plugin_actived']) && ($only == 'ads' || $only == 'all')){ if( file_exists("assets/plugins/ads/request_ads.php") ){  include "assets/plugins/ads/request_ads.php";  } }

if(in_array('Question', $wo['plugin_list']['plugin_actived']) && ($only == 'question' || $only == 'all')){ if( file_exists("assets/plugins/question/request_question.php") ){  
include "assets/plugins/question/request_question.php";  } }

if(in_array('Share', $wo['plugin_list']['plugin_actived']) && ($only == 'share' || $only == 'all')){ if( file_exists("assets/plugins/share/request_share.php") ){  include "assets/plugins/share/request_share.php";  } }

if(in_array('Pokes', $wo['plugin_list']['plugin_actived']) && ($only == 'pokes' || $only == 'all')){ if( file_exists("assets/plugins/pokes/request_pokes.php") ){  include "assets/plugins/pokes/request_pokes.php";  } }

if(in_array('Points', $wo['plugin_list']['plugin_actived']) && ($only == 'points' || $only == 'all')){ if( file_exists("assets/plugins/points/request_points.php") ){  include "assets/plugins/points/request_points.php";  } }

if(in_array('Campaign', $wo['plugin_list']['plugin_actived']) && ($only == 'campaign' || $only == 'all')){ if( file_exists("assets/plugins/campaign/request_campaign.php") ){  include "assets/plugins/campaign/request_campaign.php";  } }

if(in_array('Combo', $wo['plugin_list']['plugin_actived']) && ($only == 'combo' || $only == 'all')){ if( file_exists("assets/plugins/combo/request_combo.php") ){  include "assets/plugins/combo/request_combo.php";  } }

if(in_array('Ecard', $wo['plugin_list']['plugin_actived']) && ($only == 'ecard' || $only == 'all')){ if( file_exists("assets/plugins/ecard/request_ecard.php") ){  include "assets/plugins/ecard/request_ecard.php";  } }
