...
if(isset($_POST['submit'])) {
	...
	$sql = "
		...
		`display_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
		`type` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
		`type_content` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
		`plan_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
		`plan_id` int(11) NOT NULL DEFAULT '0',
		`quantity` int(11) NOT NULL DEFAULT '0',
		`target_location` varchar(999) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
		...
		`position` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
		`ad_public` int(11) NOT NULL DEFAULT '0',
		`ad_html` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
		`created` int(11) NOT NULL DEFAULT '0',
		`updated` int(11) NOT NULL DEFAULT '0',
				...
				<div class="col-sm-12">
					...
					<div class="panel panel-default"> 
						...
						<div class="panel-body pg_1x">	
							...
							<div class="col-sm-7">
								<img src="../assets/plugins/img/cover.jpg" width="100%">							
								<div class="panel panel-default">
