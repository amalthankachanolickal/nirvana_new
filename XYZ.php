...
<title>Website Advertisements Payment :</title>
...
margin:20px;!important ">
               ...
               <div class="row">
                      ...
                      <div class="col-lg-4 no-pdd">
                        ...
                        <div class="col-lg-8 no-pdd"> <h3>Website Advertisements Payment</h3>  </div>
                    ...
                    <form action="<?php echo $action; ?>" method="post" name="payuForm">
                        ...
                        <input type="hidden"  name="udf1" value="AdsPayments"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12 no-pdd">
                          ...
                          <div class="sn-field">
                           ...
                           <input type="text" name="amount" id="amount" value="<?php echo $posted['amount']; ?>"  onKeyPress="return isNumberKey(event);" maxlength="6"  required/>
