...
<?php include(ROOTACCESS."front_header_back.php");?>
          ...
          <div class="single-news">
            ...
            <div class="news-image">
              ...
              <div class="news-date">
                ...
                <p><?php echo ucwords($DayDisplay);?><span style="display:block;"><?php echo substr($HomeEventsVal['event_month'],0,3);?> 21</span></p>
            ...
            <a href="event.php?eid=<?php echo $HomeEventsVal['id'];?>" >
            <!--<a href="#" style="ursor: pointer;text-decoration:none;">-->
