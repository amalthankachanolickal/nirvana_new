...
<option  value="0" >0 </option>
 ...
 <div class="col-sm-3">
                ...
                <!--<label class="control-label" id="a2"><?php echo 1200;?> <span class="text-danger border border-primary"></span></label> -->
                </div>
              
              <div class="col-sm-3">
                <label class="control-label ">Total <span class="text-danger">*</span></label><br>
                <input id="a3" disabled type="text" name="total_amt_sc" />
               <!-- <label class="control-label" id="a3"><?php echo 1200;?> <span class="text-danger border border-primary"></span></label> -->
                </div>
...
<option  value="0" >0 </option>
           ...
           <div class="col-sm-3">
                <label class="control-label ">Price <span class="text-danger">*</span></label><br>
                <input id="a6"  disabled type="text"  value="<?php echo $HomeEventsVal['price_of_ticket_before_ad'];?>"   />
                <!--<label class="control-label" id="a2"><?php echo 1200;?> <span class="text-danger border border-primary"></span></label> -->
                </div>
...
<option  value="Cash/Cheque" >Cash/Cheque </option>
            ...
            <div class="col-sm-3">
                <label class="control-label ">Total <span class="text-danger">*</span></label><br>
                <input id="a19" disabled type="text" name="total_amt_kdr" />
               <!-- <label class="control-label" id="a3"><?php echo 1200;?> <span class="text-danger border border-primary"></span></label> -->
                </div>
            ...
            <div class="col-sm-3">
                  <input id="a9" disabled type="text" name="total_amte"  />
            </div>
...
calculate = function()
{
    ...
    var ek = document.getElementById('a3').value; 
     v1= parseInt(minutes);

    v5=parseInt(v1)-parseInt(v2)-parseInt(v3)-parseInt(v4);
   document.getElementById('a19').value=parseInt(v5); 
