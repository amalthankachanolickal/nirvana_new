...
<div class="container">
   ...
   <!--=====================Rent and Looking for Desktop view==========================================-->
                            ...
                            <table class="table table-striped table-hover dt-responsive" id="dataTable" style="width: 100%" >
                                ...
                                <thead>
                                       ...
                                       <tr >
                                        ...
                                        <th style="background-color:#4267B2;text-align:center;width:14%" scope="col">Rental</th>
                                        ...
                                        <th style="background-color:#4267B2;text-align:center;width:8%" scope="col">Block</th>
                                       <!-- <th style="background-color:#0040ff;text-align:center;width:10%" scope="col">Avbl</th>-->
                                        <th style="background-color:#4267B2;text-align:center;width:24%" scope="col">Description</th>
                                ...
                                <tbody>
                                    ...
                                    if($property['approved']==1 && ($property['listing_type'] == "rent" || $property['listing_type'] == "Looking for Rent")){
                                    $id=$property['id'];
                                    ...
                                    if(strlen($description) >25){
                                        $description = substr($property['description'], 0, 25)."...";
                                    }
